...
if __name__ == "__main__":
    ...
    # Creating an instance of LineIntersection with the following input
    line_intersection = LineIntersection([(0.78, 1.47, 1.77, 3.92), ("s1", "s2", "e1", "e2")])

    # Calling the necessary methods
    line_intersection.convert_to_coords()
    slope1, slope2 = line_intersection.calculate_slopes()
    line_intersection.check_intersection(slope1, slope2)
    line_intersection.print_intersection_count()
